...
from infrastructure.exporters.metrics_cache import load_cache, save_cache, get_previous_month_key, get_annual_monthly_breakdown, get_year_accumulated, get_all_years_from_cache
...
class GenerateReportUseCase:
    ...
    async def _generate_monthly(self, year: int, month: int, output_dir: str, skip_os: bool, sector: Optional[str]):
    ...
    async def _generate_annual(self, year: int, output_dir: str, skip_os: bool, sector: Optional[str]):
    ...
    async def _generate_system_total(self, output_dir: str, skip_os: bool, sector: Optional[str]):
