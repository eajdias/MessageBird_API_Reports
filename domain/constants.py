...
DEFAULT_KPI_CONFIG = {
    "Suporte Técnico": {
        "t1": [
            {
                ...
                "description": "Notas 4 e 5 são consideradas Feedback positivo. índice ponderado pela cobertura de avaliação (veja '% Chats Avaliados (Nota)').",
                "metric": "% em cima do total de atendimentos (ponderado pela cobertura)",
                "meta": ">40%", "peso": 25, "tipo": "escalonado_percentual",
                "niveis": [{"min": 40, "pts": 25, "extra_per_unit": 0.5}, {"min": 35, "pts": 12}, {"min": 30, "pts": 8}],
                "cap": 50,
            },
            {
            ...
            },
            {
                ...
                "metric": "% em cima do total de atendimentos",
                "meta": "≤5%", "peso": -5, "tipo": "penalidade_taxa",
                "threshold": 5, "cap": -30, "extra_peso": -5,
            },
        ...
        "t2": [
             ...
             {"name": "% Chats Avaliados (Nota)", "meta": "-", "peso": "-", "tipo": "-"},
             {"name": "% Atendimentos com NPS", "meta": "-", "peso": "-", "tipo": "-"},
         ],
